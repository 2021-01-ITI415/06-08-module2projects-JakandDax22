...
//The slot class isn't a subclass of monobehavior, so it doesn't need a separate C# file
...
public class Layout : MonoBehaviour
{
    ...
    public PT_XMLHashtable xml; //This is a variable is for faster xml
    public Vector2 multiplier; //The offset of the tableau's center
    //SlotDef references
    public List<SlotDef> slotDefs; //All of the slotDefs for Row0-Row3
    public SlotDef drawPile;
    public SlotDef discardPile;
    //This holds all of the possible names for the layers set by layerID
    public string[] sortingLayerNames = new string[] { "Row0", "Row1", "Row2", "Row3", "Row4", "Row5", "Draw", "Discard" };
    ...
    public void ReadLayout(string xmlText)
    {
        ...
        for (int i=0; i < slotsX.Count; i++)
        {
            ...
            switch (tSD.type)
            {
                //pull additionall attributes based on the type of this <slot>
                case "slot":
